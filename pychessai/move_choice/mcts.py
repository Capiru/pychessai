...
from pychessai.config import BaseConfig
...
class MCTSConfig(BaseConfig):
    ...
    c_puct: float = 0.0
    epsilon: float = 0.0
    turn_based_flip: bool = False
    exploit_child_value: bool = False
...
class MCTS:
    def __init__(self, model, mcts_config: MCTSConfig):
        ...
        self.dir_epsilon = mcts_config.dirichlet_epsilon
        self.dir_noise = mcts_config.dirichlet_noise
        ...
        self.c_puct = mcts_config.puct_coefficient
        self.epsilon = mcts_config.epsilon
        self.turn_based_flip = mcts_config.turn_based_flip
        self.exploit_child_value = mcts_config.argmax_child_value
